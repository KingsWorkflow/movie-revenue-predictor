...
def render_sidebar(df):
    with st.sidebar:
        ...
        <div class="sidebar-footer">
            Team Marle-G<br>King's College Nepal<br>
            Westcliff University<br>PRG-200 · Prof. Pandey<br><br>
...
def page_about(df):
    ...
    with col2:
        st.markdown('<div class="card" style="margin-bottom:1.25rem;"><div class="card-title">Team Marle-G</div>', unsafe_allow_html=True)
        for name,role,handle in [("Anuprash Pokharel","Project Lead","AnuPrasHPoKhareL29"),("Kabit Khadka","Statistical Analyst","kabit-k"),("Prashanna Dhami","App Developer","prashannaLeo"),("Sarjyant Maharjan","Data Engineer","SarjyantM"),("Prajit Shrestha","Research Analyst","prajit-shrestha")]:
